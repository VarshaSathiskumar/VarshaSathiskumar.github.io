...
const tech_stack_items = [
  ...
  { label: "SQL", logo_src: `${tech_icon_base_path}/postgresql.svg`, bold_icon: true },
  ...
  { label: "ML Libraries", bold_icon: true, logo_svg: `
    <svg viewBox="0 0 24 24" width="100%" height="100%" role="img" aria-label="ML Libraries">
      ...
      <circle cx="4.5" cy="6" r="2.3" fill="#111111"/>
      <circle cx="19.5" cy="6" r="2.3" fill="#111111"/>
      <circle cx="4.5" cy="18" r="2.3" fill="#111111"/>
      <circle cx="19.5" cy="18" r="2.3" fill="#111111"/>
      <path fill="none" stroke="#111111" stroke-width="1.8" d="M12 12L4.5 6M12 12l7.5-6M12 12l-7.5 6M12 12l7.5 6"/>
    </svg>
  ` }
]
